 ...
 */
public class AssertionsRuleTestEnabled {

    @Rule
    public AssertionsRule assertionsRule = new AssertionsRule().enabled();

    @Test
    public void testAssertionsRuleEnabled_noAssertions() {
    ...
    @Assertions
    @Test
    public void testAssertionsRuleEnabled_Assertions_noarg() {
        assumeTrue(true);
    ...
    @Test
    public void testAssertionsRuleEnabled_Assertions_enabledTrue() {
    ...
    @Test
    public void testAssertionsRuleEnabled_Assertions_enabledFalse() {
        assumeTrue(true);
