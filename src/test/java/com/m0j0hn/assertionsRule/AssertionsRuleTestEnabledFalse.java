 ...
 */
public class AssertionsRuleTestEnabledFalse {

    @Rule
    public AssertionsRule assertionsRule = new AssertionsRule().enabled(false);

    @Test
    public void testAssertionsRuleEnabledFalse_noAssertions() {
    ...
    @Assertions
    @Test
    public void testAssertionsRuleEnabledFalse_Assertions_noarg() {
        assumeTrue(true);
    ...
    @Test
    public void testAssertionsRuleEnabledFalse_Assertions_enabledTrue() {
    ...
    @Test
    public void testAssertionsRuleEnabledFalse_Assertions_enabledFalse() {
        assumeTrue(true);
